...
## 6. Later still — W3D1's status indicator, pulled forward: the feed now belongs to the shell
...
### What changed on disk, fourth pass
...
daily_updates/2026-09-17.md               §6
plans/current.md                          row B
```
>>>>>>> 63bb40d (feat(desktop): the feed belongs to the shell -- one connection, four-state pill in the topbar)
